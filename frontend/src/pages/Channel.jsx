...
export default function Channel() {
  ...
  // --------------------------------------------------
  // OPEN WHATSAPP WITH SELECTED ISSUE TYPE
  // --------------------------------------------------
  ...
  try {
    const response = await fetch(
      'http://localhost:3100/api/whatsapp/session',
      {
        ...
        body: JSON.stringify({
          issueType: selectedCategory.title,
        }),
      }
    )
    ...
    if (!response.ok) {
      throw new Error(
        data.message || 'Failed to start WhatsApp reporting'
      )
    }

    const message =
      `Hi, I want to report a ${selectedCategory.title} issue.`
    ...
    console.error(
      'WhatsApp reporting error:',
      error
    )

    alert(
      error.message ||
        'Unable to start WhatsApp reporting'
    )
  }
}
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              How would you like to report this issue?
            </p>
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow =
                    '0 12px 48px rgba(14,17,23,0.14)'
